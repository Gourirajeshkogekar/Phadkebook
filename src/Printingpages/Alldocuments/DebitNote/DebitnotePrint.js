    ...
    >
      ...
      <Box display="flex" justifyContent="space-between" mb={4}>
        ...
        <Box sx={{ maxWidth: "60%" }}>
          ...
          <Box sx={{ mt: 1, ml: 2 }}>
            <Typography fontSize={13}>{address}</Typography>
            <Typography fontSize={13}>{district}</Typography>
          </Box>

          <Typography fontWeight={700} fontSize={13} sx={{ mt: 2 }}>
            Dist. - {district}
          </Typography>
      ...
      <Box sx={{ px: 4 }}>
        ...
        <Typography fontSize={14}>
          We have debited your account with the sum of Rs.
        ...
        <Box sx={{ mt: 6, width: "100%" }}>
          ...
          {particulars.length === 0 ? (
            <Typography fontSize={14}>No debit note data available</Typography>
          ) : (
          ...
          >
            ...
            <Box sx={{ borderBottom: "3px double black", px: 1 }}>
              <Typography fontWeight={700} fontSize={14}>
                {totalAmount}
              </Typography>
            </Box>
        ...
        <Typography sx={{ mt: 5, fontSize: 13, fontStyle: "italic" }}>
          Commission
        </Typography>

      </Box>

      <Divider sx={{ borderBottomWidth: 1.5, mt: 8, borderColor: "black" }} />
