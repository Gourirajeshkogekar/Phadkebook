  ...
  const fetchData = async () => {
    ...
    try {
      ...
      const res = await axios.get(
        "https://publication.microtechsolutions.net.in/php/get/getCashFlowMonthlywise.php",
        {
          params:{
            fromdate:startDate,
            todate:endDate,
      ...
      <Box width={540}>
        ...
        <Paper elevation={5} sx={{p:2.5}}>
          ...
          <Autocomplete
            ...
            loading={loading}
            value={groups.find(g=>g.GroupName===accountGroup) || null}
            onChange={(e,val)=>setAccountGroup(val?.GroupName || "")}
