...
export default function DayBook() {
  ...
  const [options, setOptions] = useState([
    { id: 1, label: "Credit Note", key: "creditNote", checked: false },
    { id: 2, label: "Debit Note", key: "debitNote", checked: false },
    { id: 3, label: "JV", key: "jv", checked: false },
    { id: 4, label: "Payments", key: "payments", checked: false },
    { id: 5, label: "Purchase", key: "purchase", checked: false },
    { id: 6, label: "Purchase Return - Debit Note", key: "purchaseReturnDebitNote", checked: false },
    { id: 7, label: "Receipts", key: "receipts", checked: false },
    { id: 8, label: "Sales Invoice", key: "salesInvoice", checked: false }
  ]);
  ...
  const handlePrint = async () => {
    ...
    try {
      ...
      const params = {
        fromdate: startDate,
        todate: endDate,
        selectALL: mode === "all" ? 1 : 0
      };

      options.forEach(opt => {
        params[opt.key] = opt.checked ? 1 : 0;
      });

      const res = await axios.get(
        "https://publication.microtechsolutions.net.in/php/get/getDayBook.php",
        { params }
      );
      ...
      <Box width={540}>
        ...
        <Paper sx={{ p: 2.5, borderRadius: 3, mb: 3 }}>
          ...
          <RadioGroup
            ...
            onChange={(e) => handleModeChange(e.target.value)}
          >
            <FormControlLabel value="all" control={<Radio size="small" />} label="Select All"/>
