...
import Trialbalsimpleprint from "./TrialbalsimplePrint";
import jsPDF from "jspdf";
import html2canvas from "html2canvas";


function TrialBalanceSimple() {
...
const [printing, setPrinting] = useState(false);
 ...
 Trial Balance - Simple
                ...
                <Box display="flex" flexDirection="column" justifyContent="space-between">
                  <Box display="flex" flexDirection="column">
                    <FormControlLabel
                      ...
                      label={<Typography variant="caption">Summarised Trial Bal.?</Typography>}
                    />
                    <FormControlLabel
                      control={<Checkbox size="small" checked={opening} onChange={e => setOpening(e.target.checked)} />}
                      label={<Typography variant="caption">Opening Trial Balance?</Typography>}
                    />
                  </Box>
       ...
       <Box sx={{ position: "absolute", top: "-10000px", left: "-10000px" }}>
              <div ref={reportRef}>
                <Trialbalsimpleprint state={{ startDate, endDate }} />
              </div>
            </Box>
    </Box>
  );
...
export default TrialBalanceSimple;