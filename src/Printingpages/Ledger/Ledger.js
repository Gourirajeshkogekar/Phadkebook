...
//   navigate(
//     `/printing/ledger/ledgerprint?fromdate=${startDate}&todate=${endDate}&viewType=${viewType}&ids=${ids}&prePrinted=${prePrintedStationary}`
//   );
// };
...
const handlePrint = () => {
  ...
  return (
    <Paper>
      <Typography variant="h5" mb={2} textAlign='center' fontWeight={700}>Ledger Report</Typography>
